...
<body>
<?php $__FOR_START_27600__=0;$__FOR_END_27600__=7;for($j=$__FOR_START_27600__;$j < $__FOR_END_27600__;$j+=1){ ?><div data-role="page" id="page<?php echo ($j); ?>">
	...
	<div data-role="content" >
		<table border="0" width="100%" class="course" cellspacing="1px">
			...
			<?php $__FOR_START_30665__=0;$__FOR_END_30665__=6;for($i=$__FOR_START_30665__;$i < $__FOR_END_30665__;$i+=1){ ?><tr><td style="width:30%"><?php echo ($i*2+1); ?>,<?php echo ($i*2+2); ?>节</td><td><?php echo ($classes[$j][$i]); ?></td></tr><?php } ?>
		</table>
	</div>

                    ...
                    <fieldset>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <input type="text" class="span6 title" id="title"  name="title" data-provide="title" value="<?php echo ($info["title"]); ?>">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select id="category" name="category">
                                    <?php if(is_array($Qcate)): foreach($Qcate as $key=>$cate): ?><option value="<?php echo ($key); ?>" <?php if($key==$info['category']){echo 'selected="selected"';}?>><?php echo ($cate); ?></option><?php endforeach; endif; ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select id="type" name="difficulty">
                                    <?php for($i=1;$i<=5;$i++){?>
                                    <option value="<?php echo $i.'"'; if($i==$info['type']){ echo 'selected="selected"';}?>><?php echo $i;?>星</option>
                                    <?php }?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select id="type" name="is_show">
                                    <option value="1" <?php if(1==$info['is_show']){echo 'selected="selected"';}?>>显示</option>
                                    <option value="0" <?php if(0==$info['is_show']){echo 'selected="selected"';}?>>隐藏</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select id="type" name="type">
                                    <?php if(is_array($Qtype)): foreach($Qtype as $key=>$type): ?><option value="<?php echo ($key); ?>" <?php if($key==$info['type']){echo 'selected="selected"';}?>><?php echo ($type); ?></option><?php endforeach; endif; ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <?php foreach($info['options'] as $key =>$value){ if($key>0){echo '<br><br>';}?>
                                    <input type="text" class="span2 options" id="options" name="options[<?php echo $key;?>]" data-provide="options" value="<?php echo $value;?>">
                                <?php }?>
                        ...
                        <div class="control-group hidden-phone">
                            ...
                            <div class="controls">
                                <textarea class="kindEditor" name="description" id="description" rows="3" style="height: 400px;" value="<?php echo ($info["description"]); ?>"><?php echo ($info["description"]); ?></textarea>
                            </div>
                        </div>
                        <div class="control-group hidden-phone">
                            <label class="control-label" for="answer">题目答案(答案填选项索引，多选加,)</label>
                            <div class="controls">
                                <textarea class="kindEditor" name="answer" id="answer" rows="3" style="height: 400px;"><?php echo ($info["answer"]); ?></textarea>
                            </div>
                        </div>
                        <div class="control-group hidden-phone">
                            <label class="control-label" for="answer">答案描述</label>
                            <div class="controls">
                                <textarea class="kindEditor" name="answer_des" id="answer_des" rows="3" style="height: 400px;"><?php echo ($info["answer_des"]); ?></textarea>
                            </div>
                        </div>

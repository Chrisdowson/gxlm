...
<div class="box-header" data-original-title>
    <h2><i class="halflings-icon user"></i><span class="break"></span>题目数量</h2>
    <div class="box-icon">
...
<?php if(is_array($lists)): foreach($lists as $key=>$lists): ?><tr>
        ...
        <td><?php echo mb_substr($lists['title'],0,60,'utf-8');?></td>
        <td class="center"><?php echo ($lists["ctime"]); ?></td>
        <td class="center"><?php echo $lists['category'];?></td>
        <td class="center"><?php echo ($lists["type"]); ?></td>
        <td class="center">
            <span class="label label-<?php if($lists['is_show']){echo 'success">显示';}else{ echo 'important">不显示';}?></span>
        </td>
        <td class="center">
            <a class="btn btn-success" href="../../../index/detail.html?id=<?php echo ($lists["id"]); ?>">
                <i class="halflings-icon white zoom-in"></i>
            </a>
            <a class="btn btn-info" href="./edit.html?id=<?php echo ($lists["id"]); ?>">
                <i class="halflings-icon white edit"></i>
            </a>
            <a class="btn btn-danger" href="./del.html?id=<?php echo ($lists["id"]); ?>">

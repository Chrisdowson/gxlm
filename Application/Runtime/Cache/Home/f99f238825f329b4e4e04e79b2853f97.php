                ...
                <div class="m_form m_form_profile form-horizontal">
                    <div class="box-content">
                        <table class="table table-striped">
                            ...
                            <tbody>
                            <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$lists): $mod = ($i % 2 );++$i;?><tr>
                                    <td><?php echo ($lists["id"]); ?></td>
                                    <td><?php echo ($lists["pid"]); ?></td>
                                    <td class="center"><?php echo ($lists["is_judge"]); ?></td>
                                    <td class="center">
                                        <span class="label label-<?php if($lists['is_right']){echo 'success';}else{echo 'important';}?>"><?php if($lists['is_right']){echo '正确';}else{echo '错误';}?></span>
                                    </td>
                                    <td class="center"><?php echo ($lists["ctime"]); ?></td>
                                </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                            </tbody>
                        </table>
                        <?php echo W('LinkPager/LinkPager',array($pagecount,$pagenow));?>
                    </div>
                </div>
                <!-- 个人信息 end -->
            </div>
